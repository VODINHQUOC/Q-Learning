    ...
    def QlearnCalculate(self):
        ...
        for n in range(1,1000):
            ...
            while(1):
                ...
                if self.err_array[state_current] <= min(error_array):
                    break
...
if __name__ == '__main__':
    ...
    # print(reward)
    #  Training
    qlearn = Qlearing(reward_matrix=reward,Q_table=Q_table,num_state=size,num_action=size,err_array=error_array)
    print("Q table: ")
    print(Q_table)
    print("Reward : ")
    print(reward)
